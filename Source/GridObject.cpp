...
void GridObject::Draw()
{
    ...
    {
        SharedObjectShader->setUniform2i("TileCoor", WorldPtr->GetMouseState().GridX, WorldPtr->GetMouseState().GridY);
        ...
        TransformLoc = glGetUniformLocation(SharedObjectShader->ID, "Transform");
